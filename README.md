...
|------|---------|--------|--------|
| 均匀 10% | PLC only | 10% | 0% |
| 均匀 10% | LBRR (VBR) | 10% | ~17% |
| 均匀 10% | DRED 3帧 | 10% | **97.4%** |
| Gilbert突发 | DRED 5帧 | ~13% | **92%** |
| Gilbert突发 | PLC only | ~13% | 0% |

> DRED 在均匀丢包下效果最优；在突发丢包下，需要更大冗余帧数（5-10帧）。
